...
type Container struct {
	// Name of the container specified as a DNS_LABEL. // want "commentstart: godoc for field Name should start with 'name ...'"
	...
	// List of ports to expose from the container. Not specifying a port here // want "commentstart: godoc for field Ports should start with 'ports ...'"
	...
	// Compute Resources required by this container. // want "commentstart: godoc for field Resources should start with 'resources ...'"
	// Cannot be updated.
	...
	// RestartPolicy defines the restart behavior of individual containers in a pod. // want "commentstart: godoc for field RestartPolicy should start with 'restartPolicy ...'"
	...
	// Pod volumes to mount into the container's filesystem. // want "commentstart: godoc for field VolumeMounts should start with 'volumeMounts ...'"
	// Cannot be updated.
	// +optional
	...
	// Periodic probe of container liveness. // want "commentstart: godoc for field LivenessProbe should start with 'livenessProbe ...'"
	// Container will be restarted if the probe fails.
	// Cannot be updated.
	// More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
	// +optional
	LivenessProbe *Probe `json:"livenessProbe,omitempty" protobuf:"bytes,10,opt,name=livenessProbe"`
	// Periodic probe of container service readiness. // want "commentstart: godoc for field ReadinessProbe should start with 'readinessProbe ...'"
	// Container will be removed from service endpoints if the probe fails.
	// Cannot be updated.
	// More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
	// +optional
	ReadinessProbe *Probe `json:"readinessProbe,omitempty" protobuf:"bytes,11,opt,name=readinessProbe"`
	// StartupProbe indicates that the Pod has successfully initialized. // want "commentstart: godoc for field StartupProbe should start with 'startupProbe ...'"
	...
	// Actions that the management system should take in response to container lifecycle events. // want "commentstart: godoc for field Lifecycle should start with 'lifecycle ...'"
	// Cannot be updated.
	// +optional
	...
	// SecurityContext defines the security options the container should be run with. // want "commentstart: godoc for field SecurityContext should start with 'securityContext ...'"
...
type ContainerPort struct {
	// If specified, this must be an IANA_SVC_NAME and unique within the pod. Each // want "commentstart: godoc for field Name should start with 'name ...'"
	...
	// Number of port to expose on the host. // want "commentstart: godoc for field HostPort should start with 'hostPort ...'"
	...
	// Number of port to expose on the pod's IP address. // want "commentstart: godoc for field ContainerPort should start with 'containerPort ...'"
	// This must be a valid port number, 0 < x < 65536.
	ContainerPort int32 `json:"containerPort" protobuf:"varint,3,opt,name=containerPort"` // want "optionalorrequired: field ContainerPort must be marked as optional or required"
	// Protocol for port. Must be UDP, TCP, or SCTP. // want "commentstart: godoc for field Protocol should start with 'protocol ...'"
	// Defaults to "TCP".
	// +optional
	// +default="TCP"
	...
	// What host IP to bind the external port to. // want "commentstart: godoc for field HostIP should start with 'hostIP ...'"
	// +optional
...
type EnvVar struct {
	// Name of the environment variable. // want "commentstart: godoc for field Name should start with 'name ...'"
	// May consist of any printable ASCII characters except '='.
	Name string `json:"name" protobuf:"bytes,1,opt,name=name"` // want "optionalorrequired: field Name must be marked as optional or required"

	// Optional: no more than one of the following may be specified.

	// Variable references $(VAR_NAME) are expanded // want "commentstart: godoc for field Value should start with 'value ...'"
	...
	// Source for the environment variable's value. Cannot be used if value is not empty. // want "commentstart: godoc for field ValueFrom should start with 'valueFrom ...'"
	// +optional
...
type EnvVarSource struct {
	// Selects a field of the pod: supports metadata.name, metadata.namespace, `metadata.labels['<KEY>']`, `metadata.annotations['<KEY>']`, // want "commentstart: godoc for field FieldRef should start with 'fieldRef ...'"
	...
	// Selects a key of a ConfigMap. // want "commentstart: godoc for field ConfigMapKeyRef should start with 'configMapKeyRef ...'"
	// +optional
	ConfigMapKeyRef *ConfigMapKeySelector `json:"configMapKeyRef,omitempty" protobuf:"bytes,3,opt,name=configMapKeyRef"`
	// Selects a key of a secret in the pod's namespace // want "commentstart: godoc for field SecretKeyRef should start with 'secretKeyRef ...'"
	// +optional
	SecretKeyRef *SecretKeySelector `json:"secretKeyRef,omitempty" protobuf:"bytes,4,opt,name=secretKeyRef"`
	// FileKeyRef selects a key of the env file. // want "commentstart: godoc for field FileKeyRef should start with 'fileKeyRef ...'"
...
type FileKeySelector struct {
	// The name of the volume mount containing the env file. // want "commentstart: godoc for field VolumeName should start with 'volumeName ...'"
	// +required
	...
	// The path within the volume from which to select the file. // want "commentstart: godoc for field Path should start with 'path ...'"
	...
	// The key within the env file. An invalid key will prevent the pod from starting. // want "commentstart: godoc for field Key should start with 'key ...'"
	// The keys defined within a source may consist of any printable ASCII characters except '='.
	...
	// Specify whether the file or its key must be defined. If the file or key // want "commentstart: godoc for field Optional should start with 'optional ...'"
...
type ObjectFieldSelector struct {
	// Version of the schema the FieldPath is written in terms of, defaults to "v1". // want "commentstart: godoc for field APIVersion should start with 'apiVersion ...'"
	// +optional
	...
	// Path of the field to select in the specified API version. // want "commentstart: godoc for field FieldPath should start with 'fieldPath ...'"
	FieldPath string `json:"fieldPath" protobuf:"bytes,2,opt,name=fieldPath"` // want "optionalorrequired: field FieldPath must be marked as optional or required"
}

// ResourceFieldSelector represents container resources (cpu, memory) and their output format
// +structType=atomic
type ResourceFieldSelector struct {
	// Container name: required for volumes, optional for env vars // want "commentstart: godoc for field ContainerName should start with 'containerName ...'"
	// +optional
	...
	// Required: resource to select // want "commentstart: godoc for field Resource should start with 'resource ...'"
	Resource string `json:"resource" protobuf:"bytes,2,opt,name=resource"` // want "optionalorrequired: field Resource must be marked as optional or required"
...
type ConfigMapKeySelector struct {
	...
	// The key to select. // want "commentstart: godoc for field Key should start with 'key ...'"
	Key string `json:"key" protobuf:"bytes,2,opt,name=key"` // want "optionalorrequired: field Key must be marked as optional or required"
	// Specify whether the ConfigMap or its key must be defined // want "commentstart: godoc for field Optional should start with 'optional ...'"
	// +optional
...
type SecretKeySelector struct {
	...
	LocalObjectReference `json:",inline" protobuf:"bytes,1,opt,name=localObjectReference"`
	// The key of the secret to select from.  Must be a valid secret key. // want "commentstart: godoc for field Key should start with 'key ...'"
	Key string `json:"key" protobuf:"bytes,2,opt,name=key"` // want "optionalorrequired: field Key must be marked as optional or required"
	// Specify whether the Secret or its key must be defined // want "commentstart: godoc for field Optional should start with 'optional ...'"
	// +optional
	Optional *bool `json:"optional,omitempty" protobuf:"varint,3,opt,name=optional"`
}
...
type EnvFromSource struct {
	// Optional text to prepend to the name of each environment variable. // want "commentstart: godoc for field Prefix should start with 'prefix ...'"
	// May consist of any printable ASCII characters except '='.
	// +optional
	...
	// The ConfigMap to select from // want "commentstart: godoc for field ConfigMapRef should start with 'configMapRef ...'"
	// +optional
	ConfigMapRef *ConfigMapEnvSource `json:"configMapRef,omitempty" protobuf:"bytes,2,opt,name=configMapRef"`
	// The Secret to select from // want "commentstart: godoc for field SecretRef should start with 'secretRef ...'"
	// +optional
...
type ConfigMapEnvSource struct {
	// The ConfigMap to select from.
	LocalObjectReference `json:",inline" protobuf:"bytes,1,opt,name=localObjectReference"`
	// Specify whether the ConfigMap must be defined // want "commentstart: godoc for field Optional should start with 'optional ...'"
	// +optional
...
type SecretEnvSource struct {
	...
	LocalObjectReference `json:",inline" protobuf:"bytes,1,opt,name=localObjectReference"`
	// Specify whether the Secret must be defined // want "commentstart: godoc for field Optional should start with 'optional ...'"
	// +optional
	Optional *bool `json:"optional,omitempty" protobuf:"varint,2,opt,name=optional"`
}
...
type ResourceRequirements struct {
	...
	// Claims lists the names of resources, defined in spec.resourceClaims, // want "commentstart: godoc for field Claims should start with 'claims ...'"
...
type ResourceClaim struct {
	// Name must match the name of one entry in pod.spec.resourceClaims of // want "commentstart: godoc for field Name should start with 'name ...'"
	// the Pod where this field is used. It makes that resource available
	// inside a container.
	Name string `json:"name" protobuf:"bytes,1,opt,name=name"` // want "optionalorrequired: field Name must be marked as optional or required"

	// Request is the name chosen for a request in the referenced claim. // want "commentstart: godoc for field Request should start with 'request ...'"
...
type ContainerResizePolicy struct {
	// Name of the resource to which this resource resize policy applies. // want "commentstart: godoc for field ResourceName should start with 'resourceName ...'"
	// Supported values: cpu, memory.
	ResourceName ResourceName `json:"resourceName" protobuf:"bytes,1,opt,name=resourceName,casttype=ResourceName"` // want "optionalorrequired: field ResourceName must be marked as optional or required"
	// Restart policy to apply when specified resource is resized. // want "commentstart: godoc for field RestartPolicy should start with 'restartPolicy ...'"
	// If not specified, it defaults to NotRequired.
	RestartPolicy ResourceResizeRestartPolicy `json:"restartPolicy" protobuf:"bytes,2,opt,name=restartPolicy,casttype=ResourceResizeRestartPolicy"` // want "optionalorrequired: field RestartPolicy must be marked as optional or required"
}
...
type ContainerRestartRule struct {
	// Specifies the action taken on a container exit if the requirements // want "commentstart: godoc for field Action should start with 'action ...'"
	...
	// Represents the exit codes to check on container exits. // want "commentstart: godoc for field ExitCodes should start with 'exitCodes ...'"
	// +optional
	// +oneOf=when
...
type ContainerRestartRuleOnExitCodes struct {
	// Represents the relationship between the container exit code(s) and the // want "commentstart: godoc for field Operator should start with 'operator ...'"
	...
	// Specifies the set of values to check for container exit codes. // want "commentstart: godoc for field Values should start with 'values ...'"
...
type Probe struct {
	...
	// Number of seconds after the container has started before liveness probes are initiated. // want "commentstart: godoc for field InitialDelaySeconds should start with 'initialDelaySeconds ...'"
	// More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
	// +optional
	...
	// Number of seconds after which the probe times out. // want "commentstart: godoc for field TimeoutSeconds should start with 'timeoutSeconds ...'"
	...
	// How often (in seconds) to perform the probe. // want "commentstart: godoc for field PeriodSeconds should start with 'periodSeconds ...'"
	...
	// Minimum consecutive successes for the probe to be considered successful after having failed. // want "commentstart: godoc for field SuccessThreshold should start with 'successThreshold ...'"
	...
	// Minimum consecutive failures for the probe to be considered failed after having succeeded. // want "commentstart: godoc for field FailureThreshold should start with 'failureThreshold ...'"
	...
	// Optional duration in seconds the pod needs to terminate gracefully upon probe failure. // want "commentstart: godoc for field TerminationGracePeriodSeconds should start with 'terminationGracePeriodSeconds ...'"
...
type ProbeHandler struct {
	// Exec specifies a command to execute in the container. // want "commentstart: godoc for field Exec should start with 'exec ...'"
	// +optional
	Exec *ExecAction `json:"exec,omitempty" protobuf:"bytes,1,opt,name=exec"`
	// HTTPGet specifies an HTTP GET request to perform. // want "commentstart: godoc for field HTTPGet should start with 'httpGet ...'"
	// +optional
	HTTPGet *HTTPGetAction `json:"httpGet,omitempty" protobuf:"bytes,2,opt,name=httpGet"`
	// TCPSocket specifies a connection to a TCP port. // want "commentstart: godoc for field TCPSocket should start with 'tcpSocket ...'"
	// +optional
	TCPSocket *TCPSocketAction `json:"tcpSocket,omitempty" protobuf:"bytes,3,opt,name=tcpSocket"`
	// GRPC specifies a GRPC HealthCheckRequest. // want "commentstart: godoc for field GRPC should start with 'grpc ...'"
	// +optional
...
type HTTPGetAction struct {
	// Path to access on the HTTP server. // want "commentstart: godoc for field Path should start with 'path ...'"
	// +optional
	...
	// Host name to connect to, defaults to the pod IP. You probably want to set // want "commentstart: godoc for field Host should start with 'host ...'"
	// "Host" in httpHeaders instead.
	// +optional
	Host string `json:"host,omitempty" protobuf:"bytes,3,opt,name=host"` // want "optionalfields: field Host should be a pointer."
	// Scheme to use for connecting to the host. // want "commentstart: godoc for field Scheme should start with 'scheme ...'"
	// Defaults to HTTP.
	// +optional
	...
	// Custom headers to set in the request. HTTP allows repeated headers. // want "commentstart: godoc for field HTTPHeaders should start with 'httpHeaders ...'"
	// +optional
	// +listType=atomic
...
type HTTPHeader struct {
	// The header field name. // want "commentstart: godoc for field Name should start with 'name ...'"
	// This will be canonicalized upon output, so case-variant names will be understood as the same header.
	Name string `json:"name" protobuf:"bytes,1,opt,name=name"` // want "optionalorrequired: field Name must be marked as optional or required"
	// The header field value // want "commentstart: godoc for field Value should start with 'value ...'"
...
type TCPSocketAction struct {
	...
	// Optional: Host name to connect to, defaults to the pod IP. // want "commentstart: godoc for field Host should start with 'host ...'"
	// +optional
...
type GRPCAction struct {
	// Port number of the gRPC service. Number must be in the range 1 to 65535. // want "commentstart: godoc for field Port should start with 'port ...'"
	Port int32 `json:"port" protobuf:"bytes,1,opt,name=port"` // want "optionalorrequired: field Port must be marked as optional or required"

	// Service is the name of the service to place in the gRPC HealthCheckRequest // want "commentstart: godoc for field Service should start with 'service ...'"
...
type ExecAction struct {
	// Command is the command line to execute inside the container, the working directory for the // want "commentstart: godoc for field Command should start with 'command ...'"
...
type SleepAction struct {
	// Seconds is the number of seconds to sleep. // want "commentstart: godoc for field Seconds should start with 'seconds ...'"
	Seconds int64 `json:"seconds" protobuf:"bytes,1,opt,name=seconds"` // want "optionalorrequired: field Seconds must be marked as optional or required"
}
...
type Lifecycle struct {
	// PostStart is called immediately after a container is created. If the handler fails, // want "commentstart: godoc for field PostStart should start with 'postStart ...'"
	...
	// PreStop is called immediately before a container is terminated due to an // want "commentstart: godoc for field PreStop should start with 'preStop ...'"
	...
	// StopSignal defines which signal will be sent to a container when it is being stopped. // want "commentstart: godoc for field StopSignal should start with 'stopSignal ...'"
...
type LifecycleHandler struct {
	...
	// +optional
	HTTPGet *HTTPGetAction `json:"httpGet,omitempty" protobuf:"bytes,2,opt,name=httpGet"`
	// Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept for // want "commentstart: godoc for field TCPSocket should start with 'tcpSocket ...'"
	// for backward compatibility. There is no validation of this field and
	// lifecycle hooks will fail at runtime when it is specified.
	// +optional
	TCPSocket *TCPSocketAction `json:"tcpSocket,omitempty" protobuf:"bytes,3,opt,name=tcpSocket"`
	// Sleep represents a duration that the container should sleep. // want "commentstart: godoc for field Sleep should start with 'sleep ...'"
	// +optional
...
type SecurityContext struct {
	// The capabilities to add/drop when running containers. // want "commentstart: godoc for field Capabilities should start with 'capabilities ...'"
	// Defaults to the default set of capabilities granted by the container runtime.
	// Note that this field cannot be set when spec.os.name is windows.
	// +optional
	Capabilities *Capabilities `json:"capabilities,omitempty" protobuf:"bytes,1,opt,name=capabilities"`
	// Run container in privileged mode. // want "commentstart: godoc for field Privileged should start with 'privileged ...'"
	// Processes in privileged containers are essentially equivalent to root on the host.
	// Defaults to false.
	// Note that this field cannot be set when spec.os.name is windows.
	// +optional
	Privileged *bool `json:"privileged,omitempty" protobuf:"varint,2,opt,name=privileged"`
	// The SELinux context to be applied to the container. // want "commentstart: godoc for field SELinuxOptions should start with 'seLinuxOptions ...'"
	...
	// Whether this container has a read-only root filesystem. // want "commentstart: godoc for field ReadOnlyRootFilesystem should start with 'readOnlyRootFilesystem ...'"
	// Default is false.
	// Note that this field cannot be set when spec.os.name is windows.
	// +optional
	ReadOnlyRootFilesystem *bool `json:"readOnlyRootFilesystem,omitempty" protobuf:"varint,6,opt,name=readOnlyRootFilesystem"`
	// AllowPrivilegeEscalation controls whether a process can gain more // want "commentstart: godoc for field AllowPrivilegeEscalation should start with 'allowPrivilegeEscalation ...'"
	...
	// The seccomp options to use by this container. If seccomp options are // want "commentstart: godoc for field SeccompProfile should start with 'seccompProfile ...'"
...
type Capabilities struct {
	// Added capabilities // want "commentstart: godoc for field Add should start with 'add ...'"
	// +optional
	// +listType=atomic
	Add []Capability `json:"add,omitempty" protobuf:"bytes,1,rep,name=add,casttype=Capability"`
	// Removed capabilities // want "commentstart: godoc for field Drop should start with 'drop ...'"
	// +optional
	// +listType=atomic
...
type SELinuxOptions struct {
	// User is a SELinux user label that applies to the container. // want "commentstart: godoc for field User should start with 'user ...'"
	// +optional
	User string `json:"user,omitempty" protobuf:"bytes,1,opt,name=user"` // want "optionalfields: field User should be a pointer."
	// Role is a SELinux role label that applies to the container. // want "commentstart: godoc for field Role should start with 'role ...'"
	// +optional
	Role string `json:"role,omitempty" protobuf:"bytes,2,opt,name=role"` // want "optionalfields: field Role should be a pointer."
	// Type is a SELinux type label that applies to the container. // want "commentstart: godoc for field Type should start with 'type ...'"
	// +optional
	Type string `json:"type,omitempty" protobuf:"bytes,3,opt,name=type"` // want "optionalfields: field Type should be a pointer."
	// Level is SELinux level label that applies to the container. // want "commentstart: godoc for field Level should start with 'level ...'"
	// +optional
...
type WindowsSecurityContextOptions struct {
	// GMSACredentialSpecName is the name of the GMSA credential spec to use. // want "commentstart: godoc for field GMSACredentialSpecName should start with 'gmsaCredentialSpecName ...'"
	// +optional
	GMSACredentialSpecName *string `json:"gmsaCredentialSpecName,omitempty" protobuf:"bytes,1,opt,name=gmsaCredentialSpecName"`

	// GMSACredentialSpec is where the GMSA admission webhook // want "commentstart: godoc for field GMSACredentialSpec should start with 'gmsaCredentialSpec ...'"
	...
	// The UserName in Windows to run the entrypoint of the container process. // want "commentstart: godoc for field RunAsUserName should start with 'runAsUserName ...'"
	...
	// HostProcess determines if a container should be run as a 'Host Process' container. // want "commentstart: godoc for field HostProcess should start with 'hostProcess ...'"
...
type SeccompProfile struct {
	...
	// +unionDiscriminator
	Type SeccompProfileType `json:"type" protobuf:"bytes,1,opt,name=type,casttype=SeccompProfileType"` // want "optionalorrequired: field Type must be marked as optional or required"
...
type AppArmorProfile struct {
	...
	// +unionDiscriminator
	Type AppArmorProfileType `json:"type" protobuf:"bytes,1,opt,name=type,casttype=AppArmorProfileType"` // want "optionalorrequired: field Type must be marked as optional or required"
...
type HostAlias struct {
	// IP address of the host file entry. // want "commentstart: godoc for field IP should start with 'ip ...'"
	// +required
	...
	// Hostnames for the above IP address. // want "commentstart: godoc for field Hostnames should start with 'hostnames ...'"
	// +listType=atomic
	Hostnames []string `json:"hostnames,omitempty" protobuf:"bytes,2,rep,name=hostnames"` // want "optionalorrequired: field Hostnames must be marked as optional or required"
}
