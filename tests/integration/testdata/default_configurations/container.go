...
type GRPCAction struct {
	...
	// +optional
	// +default=""
	Service *string `json:"service" protobuf:"bytes,2,opt,name=service"` // want "optionalfields: field GRPCAction.Service should have the omitempty tag." "defaults: field GRPCAction.Service has a default value but does not have omitempty or omitzero in its json tag"
}
