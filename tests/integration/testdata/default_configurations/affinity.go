...
type Affinity struct {
	// Describes node affinity scheduling rules for the pod. // want "commentstart: godoc for field Affinity.NodeAffinity should start with 'nodeAffinity ...'"
	// +optional
	NodeAffinity *NodeAffinity `json:"nodeAffinity,omitempty" protobuf:"bytes,1,opt,name=nodeAffinity"`
	// Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s)). // want "commentstart: godoc for field Affinity.PodAffinity should start with 'podAffinity ...'"
	// +optional
	PodAffinity *PodAffinity `json:"podAffinity,omitempty" protobuf:"bytes,2,opt,name=podAffinity"`
	// Describes pod anti-affinity scheduling rules (e.g. avoid putting this pod in the same node, zone, etc. as some other pod(s)). // want "commentstart: godoc for field Affinity.PodAntiAffinity should start with 'podAntiAffinity ...'"
	// +optional
...
type PodAffinity struct {
	...
	// If the affinity requirements specified by this field are not met at // want "commentstart: godoc for field PodAffinity.RequiredDuringSchedulingIgnoredDuringExecution should start with 'requiredDuringSchedulingIgnoredDuringExecution ...'"
	// scheduling time, the pod will not be scheduled onto the node.
	// If the affinity requirements specified by this field cease to be met
	// at some point during pod execution (e.g. due to a pod label update), the
	...
	// The scheduler will prefer to schedule pods to nodes that satisfy // want "commentstart: godoc for field PodAffinity.PreferredDuringSchedulingIgnoredDuringExecution should start with 'preferredDuringSchedulingIgnoredDuringExecution ...'"
...
type PodAntiAffinity struct {
	...
	// If the anti-affinity requirements specified by this field are not met at // want "commentstart: godoc for field PodAntiAffinity.RequiredDuringSchedulingIgnoredDuringExecution should start with 'requiredDuringSchedulingIgnoredDuringExecution ...'"
	// scheduling time, the pod will not be scheduled onto the node.
	// If the anti-affinity requirements specified by this field cease to be met
	// at some point during pod execution (e.g. due to a pod label update), the
	// system may or may not try to eventually evict the pod from its node.
	...
	// The scheduler will prefer to schedule pods to nodes that satisfy // want "commentstart: godoc for field PodAntiAffinity.PreferredDuringSchedulingIgnoredDuringExecution should start with 'preferredDuringSchedulingIgnoredDuringExecution ...'"
...
type PodAffinityTerm struct {
	...
	// This pod should be co-located (affinity) or not co-located (anti-affinity) with the pods matching // want "commentstart: godoc for field PodAffinityTerm.TopologyKey should start with 'topologyKey ...'"
	// the labelSelector in the specified namespaces, where co-located is defined as running on a node
	// whose value of the label with key topologyKey matches that of any node on which any of the
	// selected pods is running.
	// Empty topologyKey is not allowed.
	TopologyKey string `json:"topologyKey" protobuf:"bytes,3,opt,name=topologyKey"` // want "optionalorrequired: field PodAffinityTerm.TopologyKey must be marked as optional or required"
	...
	// MatchLabelKeys is a set of pod label keys to select which pods will // want "commentstart: godoc for field PodAffinityTerm.MatchLabelKeys should start with 'matchLabelKeys ...'"
	...
	// MismatchLabelKeys is a set of pod label keys to select which pods will // want "commentstart: godoc for field PodAffinityTerm.MismatchLabelKeys should start with 'mismatchLabelKeys ...'"
	// be taken into consideration. The keys are used to lookup values from the
...
type NodeAffinity struct {
	...
	// If the affinity requirements specified by this field are not met at // want "commentstart: godoc for field NodeAffinity.RequiredDuringSchedulingIgnoredDuringExecution should start with 'requiredDuringSchedulingIgnoredDuringExecution ...'"
	// scheduling time, the pod will not be scheduled onto the node.
	// If the affinity requirements specified by this field cease to be met
	// at some point during pod execution (e.g. due to an update), the system
	...
	// The scheduler will prefer to schedule pods to nodes that satisfy // want "commentstart: godoc for field NodeAffinity.PreferredDuringSchedulingIgnoredDuringExecution should start with 'preferredDuringSchedulingIgnoredDuringExecution ...'"
	// the affinity expressions specified by this field, but it may choose
	// a node that violates one or more of the expressions. The node that is
	// most preferred is the one with the greatest sum of weights, i.e.
	// for each node that meets all of the scheduling requirements (resource
...
type Taint struct {
	// Required. The taint key to be applied to a node. // want "commentstart: godoc for field Taint.Key should start with 'key ...'"
	...
	Effect TaintEffect `json:"effect" protobuf:"bytes,3,opt,name=effect,casttype=TaintEffect"` // want "optionalorrequired: field Taint.Effect must be marked as optional or required"
...
type NodeSelector struct {
	// Required. A list of node selector terms. The terms are ORed. // want "commentstart: godoc for field NodeSelector.NodeSelectorTerms should start with 'nodeSelectorTerms ...'"
	// +listType=atomic
	NodeSelectorTerms []NodeSelectorTerm `json:"nodeSelectorTerms" protobuf:"bytes,1,rep,name=nodeSelectorTerms"` // want "optionalorrequired: field NodeSelector.NodeSelectorTerms must be marked as optional or required" "arrayofstruct: NodeSelector.NodeSelectorTerms is an array of structs, but the struct has no required fields. At least one field should be marked as required to prevent ambiguous YAML configurations"
}
...
type NodeSelectorTerm struct {
	// A list of node selector requirements by node's labels. // want "commentstart: godoc for field NodeSelectorTerm.MatchExpressions should start with 'matchExpressions ...'"
	// +optional
	// +listType=atomic
	...
	// A list of node selector requirements by node's fields. // want "commentstart: godoc for field NodeSelectorTerm.MatchFields should start with 'matchFields ...'"
	// +optional
	// +listType=atomic
...
type NodeSelectorRequirement struct {
	// The label key that the selector applies to. // want "commentstart: godoc for field NodeSelectorRequirement.Key should start with 'key ...'"
	Key string `json:"key" protobuf:"bytes,1,opt,name=key"` // want "optionalorrequired: field NodeSelectorRequirement.Key must be marked as optional or required"
	// Represents a key's relationship to a set of values. // want "commentstart: godoc for field NodeSelectorRequirement.Operator should start with 'operator ...'"
	// Valid operators are In, NotIn, Exists, DoesNotExist. Gt, and Lt.
	Operator NodeSelectorOperator `json:"operator" protobuf:"bytes,2,opt,name=operator,casttype=NodeSelectorOperator"` // want "optionalorrequired: field NodeSelectorRequirement.Operator must be marked as optional or required"
	// An array of string values. If the operator is In or NotIn, // want "commentstart: godoc for field NodeSelectorRequirement.Values should start with 'values ...'"
...
type TopologySpreadConstraint struct {
	// MaxSkew describes the degree to which pods may be unevenly distributed. // want "commentstart: godoc for field TopologySpreadConstraint.MaxSkew should start with 'maxSkew ...'"
	...
	MaxSkew int32 `json:"maxSkew" protobuf:"varint,1,opt,name=maxSkew"` // want  "optionalorrequired: field TopologySpreadConstraint.MaxSkew must be marked as optional or required"
	// TopologyKey is the key of node labels. Nodes that have a label with this key // want "commentstart: godoc for field TopologySpreadConstraint.TopologyKey should start with 'topologyKey ...'"
	...
	TopologyKey string `json:"topologyKey" protobuf:"bytes,2,opt,name=topologyKey"` // want "optionalorrequired: field TopologySpreadConstraint.TopologyKey must be marked as optional or required"

	// WhenUnsatisfiable indicates how to deal with a pod if it doesn't satisfy // want "commentstart: godoc for field TopologySpreadConstraint.WhenUnsatisfiable should start with 'whenUnsatisfiable ...'"
	...
	// It's a required field.
	WhenUnsatisfiable UnsatisfiableConstraintAction `json:"whenUnsatisfiable" protobuf:"bytes,3,opt,name=whenUnsatisfiable,casttype=UnsatisfiableConstraintAction"` // want "optionalorrequired: field TopologySpreadConstraint.WhenUnsatisfiable must be marked as optional or required"
	...
	// MinDomains indicates a minimum number of eligible domains. // want "commentstart: godoc for field TopologySpreadConstraint.MinDomains should start with 'minDomains ...'"
	...
	// NodeAffinityPolicy indicates how we will treat Pod's nodeAffinity/nodeSelector // want "commentstart: godoc for field TopologySpreadConstraint.NodeAffinityPolicy should start with 'nodeAffinityPolicy ...'"
	...
	// NodeTaintsPolicy indicates how we will treat node taints when calculating // want "commentstart: godoc for field TopologySpreadConstraint.NodeTaintsPolicy should start with 'nodeTaintsPolicy ...'"
	...
	// MatchLabelKeys is a set of pod label keys to select the pods over which // want "commentstart: godoc for field TopologySpreadConstraint.MatchLabelKeys should start with 'matchLabelKeys ...'"
