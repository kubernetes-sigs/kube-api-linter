...
type SSATagsTestSpec struct {
	...
	// +listType=set
	SetObjectList []TestObject `json:"setObjectList,omitempty"` // want "SSATagsTestSpec.SetObjectList with listType=set is not recommended due to Server-Side Apply compatibility issues. Consider using listType=atomic or listType=map instead"

	// Invalid map on primitive list - should error
	// +listType=map
	// +listMapKey=name
	MapPrimitiveList []string `json:"mapPrimitiveList,omitempty"` // want "SSATagsTestSpec.MapPrimitiveList with listType=map can only be used for object lists, not primitive lists"
	...
	// +listType=map
	MapObjectListNoKey []TestObject `json:"mapObjectListNoKey,omitempty"` // want "SSATagsTestSpec.MapObjectListNoKey with listType=map must have at least one listMapKey marker"

	// Invalid map on object list with non-existent listMapKey - should error
	// +listType=map
	// +listMapKey=nonexistent
	MapObjectListInvalidKey []TestObject `json:"mapObjectListInvalidKey,omitempty"` // want "SSATagsTestSpec.MapObjectListInvalidKey listMapKey \"nonexistent\" does not exist as a field in the struct"
	...
	MapObjectListInvalidName []SimpleObject `json:"mapObjectListInvalidName,omitempty"` // want "SSATagsTestSpec.MapObjectListInvalidName listMapKey \"invalid_name\" does not exist as a field in the struct"

	// Invalid listType value - should error
	// +listType=invalid
	InvalidListType []string `json:"invalidListType,omitempty"` // want "SSATagsTestSpec.InvalidListType has invalid listType \"invalid\", must be one of: atomic, set, map"

	// Missing listType on primitive array - should warn
	PrimitiveArrayNoMarker []string `json:"primitiveArrayNoMarker,omitempty"` // want "SSATagsTestSpec.PrimitiveArrayNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"

	// Missing listType on object array - should warn
	ObjectArrayNoMarker []TestObject `json:"objectArrayNoMarker,omitempty"` // want "SSATagsTestSpec.ObjectArrayNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"
	...
	PointerArrayNoMarker []*TestObject `json:"pointerArrayNoMarker,omitempty"` // want "SSATagsTestSpec.PointerArrayNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"
	...
	// +listType=set
	ObjectSetList []Object `json:"objectSetList,omitempty"` // want "SSATagsTestSpec.ObjectSetList with listType=set is not recommended due to Server-Side Apply compatibility issues. Consider using listType=atomic or listType=map instead"

	// Missing listType on defined type to basic type - should warn
	StringNoMarker []String `json:"stringNoMarker,omitempty"` // want "SSATagsTestSpec.StringNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"

	// Missing listType on defined type to object - should warn
	ObjectNoMarker []Object `json:"objectNoMarker,omitempty"` // want "SSATagsTestSpec.ObjectNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"
	...
	// +listType=set
	PointerToObject []*Object `json:"pointerToObject,omitempty"` // want "SSATagsTestSpec.PointerToObject with listType=set is not recommended due to Server-Side Apply compatibility issues. Consider using listType=atomic or listType=map instead"
	...
	// +listType=set
	ObjectAliasSetList []ObjectAlias `json:"objectAliasSetList,omitempty"` // want "SSATagsTestSpec.ObjectAliasSetList with listType=set is not recommended due to Server-Side Apply compatibility issues. Consider using listType=atomic or listType=map instead"

	// Missing listType on alias to basic type - should warn
	StringAliasNoMarker []StringAlias `json:"stringAliasNoMarker,omitempty"` // want "SSATagsTestSpec.StringAliasNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"

	// Missing listType on alias to object - should warn
	ObjectAliasNoMarker []ObjectAlias `json:"objectAliasNoMarker,omitempty"` // want "SSATagsTestSpec.ObjectAliasNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"
	...
	// +listType=set
	PointerToObjectAlias []*ObjectAlias `json:"pointerToObjectAlias,omitempty"` // want "SSATagsTestSpec.PointerToObjectAlias with listType=set is not recommended due to Server-Side Apply compatibility issues. Consider using listType=atomic or listType=map instead"

	// Multiple pointer levels
	PointerToPointerObject []*(*TestObject) `json:"pointerToPointerObject,omitempty"` // want "SSATagsTestSpec.PointerToPointerObject should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"
	...
	StringArrayNoMarker StringArray `json:"stringArrayNoMarker,omitempty"` // want "SSATagsTestSpec.StringArrayNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"
	...
	StringArrayAliasNoMarker StringArrayAlias `json:"stringArrayAliasNoMarker,omitempty"` // want "SSATagsTestSpec.StringArrayAliasNoMarker should have a listType marker for proper Server-Side Apply behavior \\(atomic, set, or map\\)"
	...
	// +listType=atomic
	ByteArrayWithMarker []byte `json:"byteArrayWithMarker,omitempty"` // want "SSATagsTestSpec.ByteArrayWithMarker is a byte array, which does not support the listType marker. Remove the listType marker"
