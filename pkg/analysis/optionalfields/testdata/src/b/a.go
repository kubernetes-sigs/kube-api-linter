...
type A struct {
	...
	// +optional
	StructWithOnlyOmitZero *D `json:"structWithOnlyOmitZero,omitzero"` // want "field StructWithOnlyOmitZero has the omitzero tag, but by policy is not allowed. The omitzero tag should be removed." "field StructWithOnlyOmitZero should have the omitempty tag"
	...
	// +optional
	StructWithOnlyOmitZeroWithoutPointer D `json:"structWithOnlyOmitZeroWithoutPointer,omitzero"` // want "field StructWithOnlyOmitZeroWithoutPointer has the omitzero tag, but by policy is not allowed. The omitzero tag should be removed." "field StructWithOnlyOmitZeroWithoutPointer should have the omitempty tag" "field StructWithOnlyOmitZeroWithoutPointer has a valid zero value \\(\\{\\}\\) and should be a pointer"
}
