...
type A struct {
	...
	// +optional
	StructWithRequiredFieldsFromAnotherFile StructWithRequiredField `json:"structWithRequiredFieldsFromAnotherFile,omitempty"` // want "field A.StructWithRequiredFieldsFromAnotherFile has a valid zero value \\(\\{\"string\": \"\"\\}\\) and should be a pointer."
	...
	// +optional
	StructWithValidOmitZero *D `json:"structWithValidOmitZero,omitempty,omitzero"` // want "field A.StructWithValidOmitZero has the omitzero tag, but by policy is not allowed. The omitzero tag should be removed."

	// structWithOnlyOmitZero is a struct field with a minimum number of properties on the struct so not a valid zero value.
	// +optional
	StructWithOnlyOmitZero *D `json:"structWithOnlyOmitZero,omitzero"` // want "field A.StructWithOnlyOmitZero has the omitzero tag, but by policy is not allowed. The omitzero tag should be removed." "field A.StructWithOnlyOmitZero should have the omitempty tag"
