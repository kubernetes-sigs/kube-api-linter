...
type A struct {
	...
	// +kubebuilder:validation:MinLength=1
	// +optional
	StringWithMinLength1WithoutOmitEmpty string `json:"stringWithMinLength1WithoutOmitEmpty,omitempty"` // want "field StringWithMinLength1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Minimum=1
	// +optional
	IntWithMinValue1WithoutOmitEmpty int `json:"intWithMinValue1WithoutOmitEmpty,omitempty"` // want "field IntWithMinValue1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1
	// +optional
	IntWithNegativeMaximumValueWithoutOmitEmpty int `json:"intWithNegativeMaximumValueWithoutOmitEmpty,omitempty"` // want "field IntWithNegativeMaximumValueWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Minimum=1.0
	// +optional
	FloatWithMinValue1WithoutOmitEmpty float64 `json:"floatWithMinValue1WithoutOmitEmpty,omitempty"` // want "field FloatWithMinValue1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1.0
	// +optional
	FloatWithNegativeMaximumValueWithoutOmitEmpty float64 `json:"floatWithNegativeMaximumValueWithoutOmitEmpty,omitempty"` // want "field FloatWithNegativeMaximumValueWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:MinProperties=1
	// +optional
	StructWithMinPropertiesWithoutOmitEmpty *B `json:"structWithMinPropertiesWithoutOmitEmpty,omitempty"` // want "field StructWithMinPropertiesWithoutOmitEmpty has a valid zero value \\(\\{\\}\\) and should be a pointer." "field StructWithMinPropertiesWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	StructWithNonZeroByteArray *F `json:"structWithNonZeroByteArray,omitempty"` // want "field StructWithNonZeroByteArray has a valid zero value \\(\\{\"nonZeroByteArray\": \\[\\]\\}\\) and should be a pointer." "field StructWithNonZeroByteArray does not allow the zero value. It must have the omitempty tag."

	// structWithInvalidEmptyEnum is a struct field with an invalid empty enum.
	// +optional
	StructWithInvalidEmptyEnum *G `json:"structWithInvalidEmptyEnum,omitempty"` // want "field StructWithInvalidEmptyEnum has a valid zero value \\(\\{\"enumWithoutOmitEmpty\": \"\"\\}\\) and should be a pointer." "field StructWithInvalidEmptyEnum does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	PointerStructWithRequiredFieldsWithoutOmitEmpty *C `json:"pointerStructWithRequiredFieldsWithoutOmitEmpty,omitempty"` // want "field PointerStructWithRequiredFieldsWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:MinItems=1
	// +optional
	SliceWithMinItemsWithoutOmitEmpty []string `json:"sliceWithMinItemsWithoutOmitEmpty,omitempty"` // want "field SliceWithMinItemsWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:MinProperties=1
	// +optional
	MapWithMinPropertiesWithoutOmitEmpty map[string]string `json:"mapWithMinPropertiesWithoutOmitEmpty,omitempty"` // want "field MapWithMinPropertiesWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	StringAliasWithEnumNoOmitEmpty StringAliasWithEnum `json:"stringAliasWithEnumNoOmitEmpty,omitempty"` // want "field StringAliasWithEnumNoOmitEmpty does not allow the zero value. It must have the omitempty tag."
...
type F struct {
	...
	// +kubebuilder:validation:MinLength=1
	// +optional
	NonZeroByteArray []byte `json:"nonZeroByteArray,omitempty"` // want "field NonZeroByteArray does not allow the zero value. It must have the omitempty tag."
}
...
type G struct {
	...
	// +optional
	// +kubebuilder:validation:Enum=foo;bar
	EnumWithoutOmitEmpty string `json:"enumWithoutOmitEmpty,omitempty"` // want "field EnumWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
}
