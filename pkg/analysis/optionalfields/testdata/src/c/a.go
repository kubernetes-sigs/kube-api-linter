...
type A struct {
	...
	// +optional
	PointerStringWithoutOmitEmpty *string `json:"pointerStringWithoutOmitEmpty"` // want "field A.PointerStringWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."

	// pointerStringWithMinLength1 with minimum length is a pointer string field.
	// +kubebuilder:validation:MinLength=1
	// +optional
	PointerStringWithMinLength1 *string `json:"pointerStringWithMinLength1,omitempty"` // want "field A.PointerStringWithMinLength1 does not allow the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:MinLength=0
	// +optional
	PointerStringWithMinLength0WithoutOmitempty *string `json:"pointerStringWithMinLength0WithoutOmitempty"` // want "field A.PointerStringWithMinLength0WithoutOmitempty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +optional
	PointerIntWithoutOmitEmpty *int `json:"pointerIntWithoutOmitEmpty"` // want "field A.PointerIntWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."

	// pointerIntWithMinValue1 with minimum value is a pointer int field.
	// +kubebuilder:validation:Minimum=1
	// +optional
	PointerIntWithMinValue1 *int `json:"pointerIntWithMinValue1,omitempty"` // want "field A.PointerIntWithMinValue1 does not allow the zero value. The field does not need to be a pointer."

	// pointerIntWithMinValue1WithoutOmitEmpty with minimum value is a pointer int field without omitempty.
	// +kubebuilder:validation:Minimum=1
	// +optional
	PointerIntWithMinValue1WithoutOmitEmpty *int `json:"pointerIntWithMinValue1WithoutOmitEmpty"` // want "field A.PointerIntWithMinValue1WithoutOmitEmpty does not allow the zero value. The field does not need to be a pointer." "field A.PointerIntWithMinValue1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Minimum=0
	// +optional
	PointerIntWithMinValue0WithoutOmitEmpty *int `json:"pointerIntWithMinValue0WithoutOmitEmpty"` // want "field A.PointerIntWithMinValue0WithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."

	// pointerIntWithNegativeMaximumValue with negative maximum value is a pointer int field.
	// +kubebuilder:validation:Maximum=-1
	// +optional
	PointerIntWithNegativeMaximumValue *int `json:"pointerIntWithNegativeMaximumValue,omitempty"` // want "field A.PointerIntWithNegativeMaximumValue does not allow the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:Maximum=1
	// +optional
	PointerIntWithPositiveMaximumValueWithoutOmitEmpty *int `json:"pointerIntWithPositiveMaximumValueWithoutOmitEmpty"` // want "field A.PointerIntWithPositiveMaximumValueWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:Maximum=10
	// +optional
	PointerIntWithRangeWithoutOmitEmpty *int `json:"pointerIntWithRangeWithoutOmitEmpty"` // want "field A.PointerIntWithRangeWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +optional
	PointerStructWithoutOmitEmpty *B `json:"pointerStructWithoutOmitEmpty"` // want "field A.PointerStructWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."

	// string is a string field.
	// +optional
	String string `json:"string,omitempty"` // want "field A.String has a valid zero value \\(\"\"\\), but the validation is not complete \\(e.g. minimum length\\). The field should be a pointer to allow the zero value to be set. If the zero value is not a valid use case, complete the validation and remove the pointer."
	...
	// +kubebuilder:validation:MinLength=1
	// +optional
	StringWithMinLength1WithoutOmitEmpty string `json:"stringWithMinLength1WithoutOmitEmpty"` // want "field A.StringWithMinLength1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."

	// stringWithMinLength0 with minimum length is a string field.
	// +kubebuilder:validation:MinLength=0
	// +optional
	StringWithMinLength0 string `json:"stringWithMinLength0,omitempty"` // want "field A.StringWithMinLength0 has a valid zero value \\(\"\"\\) and should be a pointer."
	...
	// +kubebuilder:validation:Enum=foo;bar;baz;""
	// +optional
	EnumStringWithEmptyValue string `json:"enumStringWithEmptyValue,omitempty"` // want "field A.EnumStringWithEmptyValue has a valid zero value \\(\"\"\\) and should be a pointer."
	...
	// int is an int field.
	// +optional
	Int int `json:"int,omitempty"` // want "field A.Int has a valid zero value \\(0\\), but the validation is not complete \\(e.g. minimum/maximum\\). The field should be a pointer to allow the zero value to be set. If the zero value is not a valid use case, complete the validation and remove the pointer."
	...
	// +kubebuilder:validation:Minimum=1
	// +optional
	IntWithMinValue1WithoutOmitEmpty int `json:"intWithMinValue1WithoutOmitEmpty"` // want "field A.IntWithMinValue1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."

	// intWithMinValue0 with minimum value is an int field.
	// +kubebuilder:validation:Minimum=0
	// +optional
	IntWithMinValue0 int `json:"intWithMinValue0,omitempty"` // want "field A.IntWithMinValue0 has a valid zero value \\(0\\) and should be a pointer."
	...
	// +kubebuilder:validation:Maximum=10
	// +optional
	IntWithRange int `json:"intWithRange,omitempty"` // want "field A.IntWithRange has a valid zero value \\(0\\) and should be a pointer."
	...
	// +optional
	IntWithInvalidMinimumValue int `json:"intWithInvalidMinimumValue,omitempty"` // want "field A.IntWithInvalidMinimumValue has an invalid minimum marker: error getting marker value: error converting value to number: strconv.ParseFloat: parsing \\\"foo\\\": invalid syntax"

	// intWithInvalidMaximumValue with invalid maximum value is an int field.
	// +kubebuilder:validation:Maximum=foo
	// +optional
	IntWithInvalidMaximumValue int `json:"intWithInvalidMaximumValue,omitempty"` // want "field A.IntWithInvalidMaximumValue has an invalid maximum marker: error getting marker value: error converting value to number: strconv.ParseFloat: parsing \\\"foo\\\": invalid syntax"

	// float is a float field.
	// +optional
	Float float64 `json:"float,omitempty"` // want "field A.Float has a valid zero value \\(0.0\\), but the validation is not complete \\(e.g. minimum/maximum\\). The field should be a pointer to allow the zero value to be set. If the zero value is not a valid use case, complete the validation and remove the pointer."
	...
	// +kubebuilder:validation:Minimum=1.0
	// +optional
	FloatWithMinValue1WithoutOmitEmpty float64 `json:"floatWithMinValue1WithoutOmitEmpty"` // want "field A.FloatWithMinValue1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."

	// floatWithMinValue0 with minimum value is a float field.
	// +kubebuilder:validation:Minimum=0.0
	// +optional
	FloatWithMinValue0 float64 `json:"floatWithMinValue0,omitempty"` // want "field A.FloatWithMinValue0 has a valid zero value \\(0.0\\) and should be a pointer."
	...
	// +kubebuilder:validation:Maximum=-1.0
	// +optional
	FloatWithNegativeMaximumValueWithoutOmitEmpty float64 `json:"floatWithNegativeMaximumValueWithoutOmitEmpty"` // want "field A.FloatWithNegativeMaximumValueWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."

	// floatWithNegativeMinimumValue with negative minimum value is a float field.
	// +kubebuilder:validation:Minimum=-1.0
	// +optional
	FloatWithNegativeMinimumValue float64 `json:"floatWithNegativeMinimumValue,omitempty"` // want "field A.FloatWithNegativeMinimumValue has a valid zero value \\(0.0\\), but the validation is not complete \\(e.g. minimum/maximum\\). The field should be a pointer to allow the zero value to be set. If the zero value is not a valid use case, complete the validation and remove the pointer."
	...
	// +optional
	FloatWithRange float64 `json:"floatWithRange,omitempty"` // want "field A.FloatWithRange has a valid zero value \\(0.0\\) and should be a pointer."
	...
	// +kubebuilder:validation:Minimum=foo
	// +optional
	FloatWithInvalidMinimumValue float64 `json:"floatWithInvalidMinimumValue,omitempty"` // want "field A.FloatWithInvalidMinimumValue has an invalid minimum marker: error getting marker value: error converting value to number: strconv.ParseFloat: parsing \\\"foo\\\": invalid syntax"

	// floatWithInvalidMaximumValue with invalid maximum value is a float field.
	// +kubebuilder:validation:Maximum=foo
	// +optional
	FloatWithInvalidMaximumValue float64 `json:"floatWithInvalidMaximumValue,omitempty"` // want "field A.FloatWithInvalidMaximumValue has an invalid maximum marker: error getting marker value: error converting value to number: strconv.ParseFloat: parsing \\\"foo\\\": invalid syntax"

	// structWithOptionalFields is a struct field.
	// +optional
	StructWithOptionalFields B `json:"structWithOptionalFields,omitempty"` // want "field A.StructWithOptionalFields has a valid zero value \\(\\{\\}\\), but the validation is not complete \\(e.g. min properties/adding required fields\\). The field should be a pointer to allow the zero value to be set. If the zero value is not a valid use case, complete the validation and remove the pointer."
	...
	// +optional
	StructWithMinProperties B `json:"structWithMinProperties,omitempty"` // want "field A.StructWithMinProperties has a valid zero value \\(\\{\\}\\) and should be a pointer."

	// structWithMinPropertiesWithoutOmitEmpty is a struct field with a minimum number of properties without omitempty.
	// +kubebuilder:validation:MinProperties=1
	// +optional
	StructWithMinPropertiesWithoutOmitEmpty B `json:"structWithMinPropertiesWithoutOmitEmpty"` // want "field A.StructWithMinPropertiesWithoutOmitEmpty has a valid zero value \\(\\{\\}\\) and should be a pointer." "field A.StructWithMinPropertiesWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."

	// structWithMinPropertiesOnStruct is a struct field with a minimum number of properties on the struct.
	// +optional
	StructWithMinPropertiesOnStruct D `json:"structWithMinPropertiesOnStruct,omitempty"` // want "field A.StructWithMinPropertiesOnStruct has a valid zero value \\(\\{\\}\\) and should be a pointer."
	...
	// +optional
	StructWithRequiredFields C `json:"structWithRequiredFields,omitempty"` // want "field A.StructWithRequiredFields has a valid zero value \\(\\{\"string\": \"\"\\}\\) and should be a pointer."
	...
	// +optional
	StructWithRequiredFieldsWithNonZeroAllowedValuesWithoutOmitEmpty C `json:"structWithRequiredFieldsWithNonZeroAllowedValuesWithoutOmitEmpty"` // want "field A.StructWithRequiredFieldsWithNonZeroAllowedValuesWithoutOmitEmpty has a valid zero value \\(\\{\"string\": \"\"\\}\\) and should be a pointer." "field A.StructWithRequiredFieldsWithNonZeroAllowedValuesWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."

	// structWithNonZeroByteArray is a struct field with a non-zero byte array.
	// +optional
	StructWithNonZeroByteArray F `json:"structWithNonZeroByteArray"` // want "field A.StructWithNonZeroByteArray has a valid zero value \\(\\{\"nonZeroByteArray\": \\[\\]\\}\\) and should be a pointer." "field A.StructWithNonZeroByteArray does not allow the zero value. It must have the omitempty tag."

	// structWithInvalidEmptyEnum is a struct field with an invalid empty enum.
	// +optional
	StructWithInvalidEmptyEnum G `json:"structWithInvalidEmptyEnum"` // want "field A.StructWithInvalidEmptyEnum has a valid zero value \\(\\{\"enumWithoutOmitEmpty\": \"\"\\}\\) and should be a pointer." "field A.StructWithInvalidEmptyEnum does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	PointerStructWithOptionalFieldsWithoutOmitEmpty *B `json:"pointerStructWithOptionalFieldsWithoutOmitEmpty"` // want "field A.PointerStructWithOptionalFieldsWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +optional
	PointerStructWithRequiredFieldsWithoutOmitEmpty *C `json:"pointerStructWithRequiredFieldsWithoutOmitEmpty"` // want "field A.PointerStructWithRequiredFieldsWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	Bool bool `json:"bool,omitempty"` // want "field A.Bool has a valid zero value \\(false\\) and should be a pointer."
	...
	// +optional
	BoolPointerWithoutOmitEmpty *bool `json:"boolPointerWithoutOmitEmpty"` // want "field A.BoolPointerWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:MinItems=1
	// +optional
	SliceWithMinItemsWithoutOmitEmpty []string `json:"sliceWithMinItemsWithoutOmitEmpty"` // want "field A.SliceWithMinItemsWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:MinProperties=1
	// +optional
	MapWithMinPropertiesWithoutOmitEmpty map[string]string `json:"mapWithMinPropertiesWithoutOmitEmpty"` // want "field A.MapWithMinPropertiesWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	StringAliasWithEnumPointer *StringAliasWithEnum `json:"stringAliasWithEnumPointer,omitempty"` // want "field A.StringAliasWithEnumPointer does not allow the zero value. The field does not need to be a pointer."

	// StringAliasWithEnumNoOmitEmpty is a string alias field with enum validation and no omitempty.
	// +optional
	StringAliasWithEnumNoOmitEmpty StringAliasWithEnum `json:"stringAliasWithEnumNoOmitEmpty"` // want "field A.StringAliasWithEnumNoOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	StructWithValidOmitZero *D `json:"structWithValidOmitZero,omitzero,omitempty"` // want "field A.StructWithValidOmitZero has the omitzero tag, but by policy is not allowed. The omitzero tag should be removed."

	// structWithOnlyOmitZero is a struct field with a minimum number of properties on the struct so not a valid zero value.
	// +optional
	StructWithOnlyOmitZero *D `json:"structWithOnlyOmitZero,omitzero"` // want "field A.StructWithOnlyOmitZero has the omitzero tag, but by policy is not allowed. The omitzero tag should be removed." "field A.StructWithOnlyOmitZero does not allow the zero value. It must have the omitempty tag."
}
...
type D struct {
	// string is a string field.
	// +optional
	String string `json:"string,omitempty"` // want "field D.String has a valid zero value \\(\"\"\\), but the validation is not complete \\(e.g. minimum length\\). The field should be a pointer to allow the zero value to be set. If the zero value is not a valid use case, complete the validation and remove the pointer."
...
type F struct {
	...
	// +kubebuilder:validation:MinLength=1
	// +optional
	NonZeroByteArray []byte `json:"nonZeroByteArray"` // want "field F.NonZeroByteArray does not allow the zero value. It must have the omitempty tag."
}
...
type G struct {
	...
	// +optional
	// +kubebuilder:validation:Enum=foo;bar
	EnumWithoutOmitEmpty string `json:"enumWithoutOmitEmpty"` // want "field G.EnumWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
}
