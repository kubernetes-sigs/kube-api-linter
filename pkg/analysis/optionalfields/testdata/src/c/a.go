...
type A struct {
	...
	// +optional
	PointerStringWithoutOmitEmpty *string `json:"pointerStringWithoutOmitEmpty"` // want "field PointerStringWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:MinLength=0
	// +optional
	PointerStringWithMinLength0WithoutOmitempty *string `json:"pointerStringWithMinLength0WithoutOmitempty"` // want "field PointerStringWithMinLength0WithoutOmitempty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +optional
	PointerIntWithoutOmitEmpty *int `json:"pointerIntWithoutOmitEmpty"` // want "field PointerIntWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:Minimum=0
	// +optional
	PointerIntWithMinValue0WithoutOmitEmpty *int `json:"pointerIntWithMinValue0WithoutOmitEmpty"` // want "field PointerIntWithMinValue0WithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:Maximum=1
	// +optional
	PointerIntWithPositiveMaximumValueWithoutOmitEmpty *int `json:"pointerIntWithPositiveMaximumValueWithoutOmitEmpty"` // want "field PointerIntWithPositiveMaximumValueWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:Maximum=10
	// +optional
	PointerIntWithRangeWithoutOmitEmpty *int `json:"pointerIntWithRangeWithoutOmitEmpty"` // want "field PointerIntWithRangeWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +optional
	PointerStructWithoutOmitEmpty *B `json:"pointerStructWithoutOmitEmpty"` // want "field PointerStructWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:MinLength=1
	// +optional
	StringWithMinLength1WithoutOmitEmpty string `json:"stringWithMinLength1WithoutOmitEmpty"` // want "field StringWithMinLength1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Enum=foo;bar;baz;""
	// +optional
	EnumStringWithEmptyValue string `json:"enumStringWithEmptyValue,omitempty"` // want "field EnumStringWithEmptyValue has a valid zero value \\(\"\"\\) and should be a pointer."
	...
	// +kubebuilder:validation:Minimum=1
	// +optional
	IntWithMinValue1WithoutOmitEmpty int `json:"intWithMinValue1WithoutOmitEmpty"` // want "field IntWithMinValue1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1
	// +optional
	IntWithNegativeMaximumValueWithoutOmitEmpty int `json:"intWithNegativeMaximumValueWithoutOmitEmpty"` // want "field IntWithNegativeMaximumValueWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Minimum=1.0
	// +optional
	FloatWithMinValue1WithoutOmitEmpty float64 `json:"floatWithMinValue1WithoutOmitEmpty"` // want "field FloatWithMinValue1WithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1.0
	// +optional
	FloatWithNegativeMaximumValueWithoutOmitEmpty float64 `json:"floatWithNegativeMaximumValueWithoutOmitEmpty"` // want "field FloatWithNegativeMaximumValueWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	StructWithMinProperties B `json:"structWithMinProperties,omitempty"` // want "field StructWithMinProperties has a valid zero value \\(\\{\\}\\) and should be a pointer."

	// structWithMinPropertiesWithoutOmitEmpty is a struct field with a minimum number of properties without omitempty.
	// +kubebuilder:validation:MinProperties=1
	// +optional
	StructWithMinPropertiesWithoutOmitEmpty B `json:"structWithMinPropertiesWithoutOmitEmpty"` // want "field StructWithMinPropertiesWithoutOmitEmpty has a valid zero value \\(\\{\\}\\) and should be a pointer." "field StructWithMinPropertiesWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."

	// structWithMinPropertiesOnStruct is a struct field with a minimum number of properties on the struct.
	// +optional
	StructWithMinPropertiesOnStruct D `json:"structWithMinPropertiesOnStruct,omitempty"` // want "field StructWithMinPropertiesOnStruct has a valid zero value \\(\\{\\}\\) and should be a pointer."
	...
	// +optional
	StructWithRequiredFieldsWithNonZeroAllowedValuesWithoutOmitEmpty C `json:"structWithRequiredFieldsWithNonZeroAllowedValuesWithoutOmitEmpty"` // want "field StructWithRequiredFieldsWithNonZeroAllowedValuesWithoutOmitEmpty has a valid zero value \\(\\{\"string\": \"\"\\}\\) and should be a pointer." "field StructWithRequiredFieldsWithNonZeroAllowedValuesWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."

	// structWithNonZeroByteArray is a struct field with a non-zero byte array.
	// +optional
	StructWithNonZeroByteArray F `json:"structWithNonZeroByteArray"` // want "field StructWithNonZeroByteArray has a valid zero value \\(\\{\"nonZeroByteArray\": \\[\\]\\}\\) and should be a pointer." "field StructWithNonZeroByteArray does not allow the zero value. It must have the omitempty tag."

	// structWithInvalidEmptyEnum is a struct field with an invalid empty enum.
	// +optional
	StructWithInvalidEmptyEnum G `json:"structWithInvalidEmptyEnum"` // want "field StructWithInvalidEmptyEnum has a valid zero value \\(\\{\"enumWithoutOmitEmpty\": \"\"\\}\\) and should be a pointer." "field StructWithInvalidEmptyEnum does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	PointerStructWithOptionalFieldsWithoutOmitEmpty *B `json:"pointerStructWithOptionalFieldsWithoutOmitEmpty"` // want "field PointerStructWithOptionalFieldsWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +optional
	PointerStructWithRequiredFieldsWithoutOmitEmpty *C `json:"pointerStructWithRequiredFieldsWithoutOmitEmpty"` // want "field PointerStructWithRequiredFieldsWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	BoolPointerWithoutOmitEmpty *bool `json:"boolPointerWithoutOmitEmpty"` // want "field BoolPointerWithoutOmitEmpty does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:MinItems=1
	// +optional
	SliceWithMinItemsWithoutOmitEmpty []string `json:"sliceWithMinItemsWithoutOmitEmpty"` // want "field SliceWithMinItemsWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:MinProperties=1
	// +optional
	MapWithMinPropertiesWithoutOmitEmpty map[string]string `json:"mapWithMinPropertiesWithoutOmitEmpty"` // want "field MapWithMinPropertiesWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	StringAliasWithEnumNoOmitEmpty StringAliasWithEnum `json:"stringAliasWithEnumNoOmitEmpty"` // want "field StringAliasWithEnumNoOmitEmpty does not allow the zero value. It must have the omitempty tag."
	...
	// +optional
	StructWithOnlyOmitZero *D `json:"structWithOnlyOmitZero,omitzero"` // want "field StructWithOnlyOmitZero has the omitzero tag, but by policy is not allowed. The omitzero tag should be removed." "field StructWithOnlyOmitZero does not allow the zero value. It must have the omitempty tag."
}
...
type F struct {
	...
	// +kubebuilder:validation:MinLength=1
	// +optional
	NonZeroByteArray []byte `json:"nonZeroByteArray"` // want "field NonZeroByteArray does not allow the zero value. It must have the omitempty tag."
}
...
type G struct {
	...
	// +optional
	// +kubebuilder:validation:Enum=foo;bar
	EnumWithoutOmitEmpty string `json:"enumWithoutOmitEmpty"` // want "field EnumWithoutOmitEmpty does not allow the zero value. It must have the omitempty tag."
}
