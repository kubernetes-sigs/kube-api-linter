...
type TestMaps struct {
	...
	MapWithZeroMinProperties map[string]string `json:"mapWithZeroMinProperties"` // want "field TestMaps.MapWithZeroMinProperties should have the omitempty tag." "field TestMaps.MapWithZeroMinProperties with MinItems=0/MinProperties=0, underlying type should be a pointer to distinguish nil \\(unset\\) from empty."

	// +kubebuilder:validation:MinProperties=0
	MapWithZeroMinPropertiesWithOmitEmpty map[string]string `json:"mapWithZeroMinPropertiesWithOmitEmpty,omitempty"` // want "field TestMaps.MapWithZeroMinPropertiesWithOmitEmpty with MinItems=0/MinProperties=0, underlying type should be a pointer to distinguish nil \\(unset\\) from empty."
}
