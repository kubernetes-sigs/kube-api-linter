...
type TestNumbers struct {
	...
	IntWithPositiveMinimum int `json:"intWithPositiveMinimum"` // want "field IntWithPositiveMinimum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1
	IntWithNegativeMaximum int `json:"intWithNegativeMaximum"` // want "field IntWithNegativeMaximum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Minimum=1
	IntPtrWithPositiveMinimum *int `json:"intPtrWithPositiveMinimum"` // want "field IntPtrWithPositiveMinimum does not allow the zero value. The field does not need to be a pointer." "field IntPtrWithPositiveMinimum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1
	IntPtrWithNegativeMaximum *int `json:"intPtrWithNegativeMaximum"` // want "field IntPtrWithNegativeMaximum does not allow the zero value. It must have the omitempty tag." "field IntPtrWithNegativeMaximum does not allow the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:Minimum=1
	Int32WithPositiveMinimum int32 `json:"int32WithPositiveMinimum"` // want "field Int32WithPositiveMinimum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1
	Int32WithNegativeMaximum int32 `json:"int32WithNegativeMaximum"` // want "field Int32WithNegativeMaximum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Minimum=1
	Int64WithPositiveMinimum int64 `json:"int64WithPositiveMinimum"` // want "field Int64WithPositiveMinimum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1
	Int64WithNegativeMaximum int64 `json:"int64WithNegativeMaximum"` // want "field Int64WithNegativeMaximum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Minimum=1
	Float32WithPositiveMinimum float32 `json:"float32WithPositiveMinimum"` // want "field Float32WithPositiveMinimum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1
	Float32WithNegativeMaximum float32 `json:"float32WithNegativeMaximum"` // want "field Float32WithNegativeMaximum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Minimum=1
	Float64WithPositiveMinimum float64 `json:"float64WithPositiveMinimum"` // want "field Float64WithPositiveMinimum does not allow the zero value. It must have the omitempty tag."
	...
	// +kubebuilder:validation:Maximum=-1
	Float64WithNegativeMaximum float64 `json:"float64WithNegativeMaximum"` // want "field Float64WithNegativeMaximum does not allow the zero value. It must have the omitempty tag."
