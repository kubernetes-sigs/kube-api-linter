...
type TestStructs struct {
	...
	StructPtrWithAllOptionalFields *StructWithAllOptionalFields `json:"structPtrWithAllOptionalFields"` // want "field StructPtrWithAllOptionalFields does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	StructWithMinProperties StructWithMinProperties `json:"structWithMinProperties"` // want "field StructWithMinProperties does not allow the zero value. It must have the omitempty tag." "field StructWithMinProperties has a valid zero value \\({}\\) and should be a pointer."
	...
	StructPtrWithMinProperties *StructWithMinProperties `json:"structPtrWithMinProperties"` // want "field StructPtrWithMinProperties does not allow the zero value. It must have the omitempty tag."
	...
	StructPtrWithNonOmittedFields *StructWithNonOmittedFields `json:"structPtrWithNonOmittedFields"` // want "field StructPtrWithNonOmittedFields does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	StructPtrWithNonOmittedFieldsAndMinProperties *StructWithNonOmittedFieldsAndMinProperties `json:"structPtrWithNonOmittedFieldsAndMinProperties"` // want "field StructPtrWithNonOmittedFieldsAndMinProperties does not have omitempty and allows the zero value. The field does not need to be a pointer."
	...
	StructPtrWithOneNonOmittedFieldAndMinProperties *StructWithOneNonOmittedFieldAndMinProperties `json:"structPtrWithOneNonOmittedFieldAndMinProperties"` // want "field StructPtrWithOneNonOmittedFieldAndMinProperties does not allow the zero value. It must have the omitempty tag."
	...
	StructWithOmittedRequiredField StructWithOmittedRequiredField `json:"structWithOmittedRequiredField"` // want "field StructWithOmittedRequiredField does not allow the zero value. It must have the omitempty tag." "field StructWithOmittedRequiredField has a valid zero value \\({}\\) and should be a pointer."
	...
	StructPtrWithOmittedRequiredField *StructWithOmittedRequiredField `json:"structPtrWithOmittedRequiredField"` // want "field StructPtrWithOmittedRequiredField does not allow the zero value. It must have the omitempty tag."
