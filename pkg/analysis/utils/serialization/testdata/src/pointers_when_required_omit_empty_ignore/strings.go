...
type TestStrings struct {
	...
	StringPtr *string `json:"stringPtr"` // want "field TestStrings.StringPtr does not have omitempty and allows the zero value. The field does not need to be a pointer."

	StringPtrWithOmitEmpty *string `json:"stringPtrWithOmitEmpty,omitempty"`

	// +kubebuilder:validation:MinLength=1
	StringWithMinLength string `json:"stringWithMinLength"` // want "field TestStrings.StringWithMinLength does not allow the zero value. It must have the omitempty tag."

	// +kubebuilder:validation:MinLength=1
	StringWithMinLengthWithOmitEmpty string `json:"stringWithMinLengthWithOmitEmpty,omitempty"`

	// +kubebuilder:validation:MinLength=1
	StringPtrWithMinLength *string `json:"stringPtrWithMinLength"` // want "field TestStrings.StringPtrWithMinLength does not allow the zero value. It must have the omitempty tag." "field TestStrings.StringPtrWithMinLength does not allow the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:MinLength=0
	StringPtrWithMinLength0 *string `json:"stringPtrWithMinLength0"` // want "field TestStrings.StringPtrWithMinLength0 does not have omitempty and allows the zero value. The field does not need to be a pointer."

	// +kubebuilder:validation:MinLength=0
	StringPtrWithMinLength0WithOmitEmpty *string `json:"stringPtrWithMinLength0WithOmitEmpty,omitempty"`

	// +kubebuilder:validation:Enum=a;b;c
	EnumString string `json:"enumString"` // want "field TestStrings.EnumString does not allow the zero value. It must have the omitempty tag."

	// +kubebuilder:validation:Enum=a;b;c
	EnumStringWithOmitEmpty string `json:"enumStringWithOmitEmpty,omitempty"`

	// +kubebuilder:validation:Enum=a;b;c
	EnumStringPtr *string `json:"enumStringPtr"` // want "field TestStrings.EnumStringPtr does not allow the zero value. It must have the omitempty tag." "field TestStrings.EnumStringPtr does not allow the zero value. The field does not need to be a pointer."
	...
	// +kubebuilder:validation:Enum=a;b;c;""
	EnumValidEmptyStringPtr *string `json:"enumValidEmptyStringPtr"` // want "field TestStrings.EnumValidEmptyStringPtr does not have omitempty and allows the zero value. The field does not need to be a pointer."
