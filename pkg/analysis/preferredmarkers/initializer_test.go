	...
	Context("config validation", func() {
		...
		DescribeTable("should validate the provided config", func(in testCase) {
					...
					Markers: []preferredmarkers.Marker{
						{
							...
							EquivalentIdentifiers: []string{"kubebuilder:validation:Optional"},
						},
					},
				},
				expectedErr: "",
					...
					Markers: []preferredmarkers.Marker{
						{
							...
							EquivalentIdentifiers: []string{"custom:old", "custom:deprecated", "custom:legacy"},
						},
					},
				},
				expectedErr: "",
				...
				config: &preferredmarkers.Config{
					Markers: []preferredmarkers.Marker{
						...
						},
						{
							...
							EquivalentIdentifiers: []string{"kubebuilder:validation:Required"},
						},
					},
				},
				expectedErr: "",
			...
			Entry("With an invalid preferredmarkers configuration, duplicate preferred markers", testCase{
				config: &preferredmarkers.Config{
					Markers: []preferredmarkers.Marker{
						...
						{
							PreferredIdentifier:   "k8s:optional",
							EquivalentIdentifiers: []string{"custom:optional"},
						},
					},
				},
			...
			Entry("With an invalid preferredmarkers configuration, duplicate equivalent identifiers within a marker", testCase{
				config: &preferredmarkers.Config{
					Markers: []preferredmarkers.Marker{
						{
							PreferredIdentifier:   "k8s:optional",
							EquivalentIdentifiers: []string{"kubebuilder:validation:Optional", "kubebuilder:validation:Optional"},
						},
					},
				},
				expectedErr: "preferredmarkers.markers[0].equivalentIdentifiers[1]: Duplicate value: \"kubebuilder:validation:Optional\"",
			}),
			Entry("With an invalid preferredmarkers configuration, duplicate equivalent identifiers across markers", testCase{
				...
				expectedErr: "preferredmarkers.markers[1].equivalentIdentifiers[0]: Duplicate value: \"custom:optional\"",
			}),
			Entry("With an invalid preferredmarkers configuration, equivalent identifier is same as preferred identifier", testCase{
				config: &preferredmarkers.Config{
					Markers: []preferredmarkers.Marker{
						...
						{
							PreferredIdentifier:   "k8s:required",
							EquivalentIdentifiers: []string{"k8s:optional"},
						},
					},
				},
				expectedErr: "preferredmarkers.markers[1].equivalentIdentifiers[0]: Invalid value: \"k8s:optional\": equivalent identifier cannot be the same as a preferred identifier",
			}),
