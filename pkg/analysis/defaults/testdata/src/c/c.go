...
type C struct {
	...
	// +optional
	// +default={}
	StructFieldMissingOmitEmpty NestedStruct `json:"structFieldMissingOmitEmpty"` // want "field C.StructFieldMissingOmitEmpty has a default value but does not have omitempty in its json tag"
