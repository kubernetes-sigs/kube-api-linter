...
type D struct {
	...
	// +optional
	// +default={}
	StructFieldMissingOmitZero NestedStruct `json:"structFieldMissingOmitZero,omitempty"` // want "field D.StructFieldMissingOmitZero has a default value but does not have omitzero in its json tag"
}
