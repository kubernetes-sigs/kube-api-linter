...
type ObjectMarkersFieldTest struct {
	...
	// +kubebuilder:validation:MinProperties=1 // want `marker "kubebuilder:validation:MinProperties": marker should be declared on the type definition of MinPropertiesType instead of the field`
	InvalidMinPropertiesOnMinPropertiesType MinPropertiesType `json:"invalidMinPropertiesOnMinPropertiesType"`

	// Invalid: MaxProperties marker on named type
	// +kubebuilder:validation:MaxProperties=10 // want `marker "kubebuilder:validation:MaxProperties": marker should be declared on the type definition of MaxPropertiesType instead of the field`
	InvalidMaxPropertiesOnMaxPropertiesType MaxPropertiesType `json:"invalidMaxPropertiesOnMaxPropertiesType"`
